...
import { getCandidateProfile, changePassword, deactivateAccount } from "@/lib/api";
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8 -mt-12">
              <div className="flex items-end gap-5">
                ...
                <div className="mb-1">
                  ...
                  <p className="text-sm text-gray-500 font-medium">{profile?.location || "No location set"}</p>
                </div>
              </div>
            ...
            {profileLoading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8 mt-6">
                ...
                <div>
                  ...
                  <p className="text-gray-900 font-medium text-lg">{profile.experienceYears != null ? `${profile.experienceYears} Years` : "—"}</p>
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <p className="text-gray-700 leading-relaxed bg-[#FDFBF7] p-5 rounded-2xl border border-[#E8E1D5]">{profile.bio || "No bio provided."}</p>
                </div>

                <div className="md:col-span-2">
                  <div className="flex items-center gap-2 mb-3 text-gray-400">
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" /></svg>
                    <p className="text-xs font-bold uppercase tracking-wider text-gray-500">Top Skills</p>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    {profile.skills?.length > 0 ? (
                      profile.skills.map((s) => (
                        <span key={s.id} className="bg-[#7A8B6A]/10 text-[#7A8B6A] border border-[#7A8B6A]/20 px-3 py-1.5 rounded-lg text-sm font-semibold tracking-wide">
                          {s.name}
                        </span>
                      ))
                    ) : (
              ...
              <p className="text-gray-500">Profile not found. Please set up your profile.</p>
            )}
          </div>
        </section>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-11 pr-4 py-3 bg-[#FDFBF7] border border-[#E8E1D5] rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-gray-900"
